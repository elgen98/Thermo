...
document.getElementById("confirmorderBtn").addEventListener("click", showModal);
let checkoutModal = document.getElementById("checkoutModal") as HTMLDivElement;

let toStart = document.getElementsByClassName(
  "startpage"
)[0] as HTMLSpanElement;
toStart.innerHTML = "Start";
...
toStart.onclick = function () {
  let startLink: HTMLAnchorElement = document.createElement("a");
  startLink.href = "./src/index.html";
  toStart.appendChild(startLink);
};
