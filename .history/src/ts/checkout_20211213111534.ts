...
function partPrice(position) {
  retrievedProducts[position].price =
    retrievedProducts[position].quantity * retrievedProducts[position].price;
  return retrievedProducts[position].price;
}
